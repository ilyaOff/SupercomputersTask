...
#define MainFunctionParallelA(res,f, w, i, j, M, N, a, h1) {\
	double center1, left1, right1;\
	center1 = w[i][j];\
...
#define MainFunctionParallelB(res,f, w, i, j, M, N, b, h2) {\
	double center1, top1, down1;\
	center1 = w[i][j];\
